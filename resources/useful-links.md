...
## Research
 ...
 | Cyberdefensemagazine | https://www.cyberdefensemagazine.com/ |
...
These are downloadable resources for widely used tools in the cybersecurity industry.
 ...
 | Nmap | https://nmap.org/download | The link to download Nmap: A open source tool for network discovery and security auditing |
 | Burpsuite | https://portswigger.net/burp/communitydownload | The link to download Burpsuite: for web security testing |
 | OWASP ZAP | https://www.zaproxy.org/ | Open source web application scanner used to find vulnerabilities during development and testing |
